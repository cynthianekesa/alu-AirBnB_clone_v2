...
class test_basemodel(unittest.TestCase):
    ...
    def test_todict(self):
        ...
        mdl_d = self.value()
        self.assertIn('_class_', self.value().to_dict())
        self.assertNotIn('_class', self.value().__dict_)
        self.assertNotEqual(mdl_d.to_dict(), mdl_d._dict_)
        self.assertNotEqual(
            mdl_d.to_dict()['_class_'],
            mdl_d._class_
        )
